...
//	依据key返回 list集合，取出某一类元素
	public List<ElementObj> getElementsByKey(GameElement ge){
		//一个延伸的小问题：String str = new String("abcd");
		//在这语句中请问共产生几个变量？分别是什么？分别存储在哪里？
		//一共产生3个变量：1.对象引用str，存储在栈  2.字符串常量"abcd"，存储在常量池（静态存储区）  
		//3.new出来的一个字符串变量String，存储在堆
...
//		gameElements.put(GameElement.BOSS, new ArrayList<ElementObj>());
		//当使用循环读取的方式时，是按枚举类型变量在枚举类中的声明顺序来进行的
